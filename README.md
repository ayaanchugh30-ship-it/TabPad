...
Open outputs/TabPad.app in Finder. Keep the app in a stable location; moving or rebuilding an ad-hoc signed app can cause macOS to request Accessibility permission again.
...
The build script creates and signs a local outputs/TabPad.app bundle.
...
## Repository layout
    ...
    outputs/                Generated TabPad.app (ignored by Git)
